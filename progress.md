...
⚠️ **Partial ground truth data** has been generated by running `run_np()` with the `@debug` decorators in place
...
2. All functions from `pdb.py`:
   - GaussianNetworkModel methods (compute_hessian, compute_K, compute_Kinv)
   - AtomicModel._get_xyz_asus
   - AtomicModel.flatten_model
   - Crystal.get_asu_xyz
...
| GaussianNetworkModel.compute_hessian | pdb.py | Not Started | Not Started | **Log file missing** |
| GaussianNetworkModel.compute_K | pdb.py | Not Started | Not Started | **Log file missing** |
| GaussianNetworkModel.compute_Kinv | pdb.py | Not Started | Not Started | **Log file missing** |
| AtomicModel._get_xyz_asus | pdb.py | Not Started | Not Started | **Log file missing** |
| AtomicModel.flatten_model | pdb.py | Not Started | Not Started | **Log file missing** |
| Crystal.get_asu_xyz | pdb.py | Not Started | Not Started | **Log file missing** |
...
### Next Steps
1. Generate missing log files for complete ground truth data
2. Implement ComplexTensorOps class in torch_utils.py
3. Create unit tests for ComplexTensorOps
4. Implement EigenOps class in torch_utils.py
5. Create unit tests for EigenOps

### Blockers and Challenges
- Incomplete ground truth data for some functions may block effective testing
