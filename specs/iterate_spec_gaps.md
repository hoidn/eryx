...
. . Given the <spec>,  rate the implementation state of this <spec> on a scale of 0 to 10, where 0 is "not implemented at all" and 10 is "fully implemented", and draft .  recommendations for resolving any gaps that you discover. Format your recommendations as a spec prompt, following the instructions of specguide.xml. 
